...
public class CostumeScreen implements Screen{

    private DungeonCoder game;
    private Stage stage;

    public CostumeScreen (DungeonCoder g) {
        game = g;
    ...
    private void createInProgress() {
        Texture inProgress = new Texture(Gdx.files.internal("UIElements/inProgress5.png"));
