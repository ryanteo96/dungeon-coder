...
public class AdventurerHud implements Disposable {
    ...
    public AdventurerHud(SpriteBatch sb, TaskOne screen){
        game = screen.getGame();
    ...
    public AdventurerHud(SpriteBatch sb, TaskThree screen){
        game = screen.getGame();
        music = DungeonCoder.manager.get("UIElements/Animation/backgroundmusic.mp3", Music.class);
        music.setLooping(true);
        music.setVolume(0.40f);
        ...
        levelLabel = new Label("3", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        worldLabel = new Label("STAGE", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
    ...
    public AdventurerHud(SpriteBatch sb, MainStory1 screen){
        game = screen.getGame();
        music = DungeonCoder.manager.get("UIElements/Animation/backgroundmusic.mp3", Music.class);
        music.setLooping(true);
        music.setVolume(0.40f);
        ...
        levelLabel = new Label("1", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        worldLabel = new Label("Main Story", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
